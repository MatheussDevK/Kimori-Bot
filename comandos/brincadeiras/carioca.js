const { imgcarioca } = require('../../config-bot/logos/links_img.json');
module.exports = {
name: 'carioca',
category: 'brincadeiras',
description: 'Sorteia uma porcentagem de chance de carioca pro alvo.',
async execute(ctx) {
...
text:`Pesquisando a ficha de carioca @${sender_ou_n.split("@")[0]}, aguarde...`,
