const { imgnazista } = require('../../config-bot/logos/links_img.json');
module.exports = {
name: 'nazista',
category: 'brincadeiras',
description: 'Sorteia uma porcentagem de chance de nazista pro alvo.',
async execute(ctx) {
...
text:`Pesquisando a ficha de nazista @${sender_ou_n.split("@")[0]}, aguarde...`,
