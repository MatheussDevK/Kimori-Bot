const { imgmacaco } = require('../../config-bot/logos/links_img.json');
module.exports = {
name: 'macaco',
category: 'brincadeiras',
description: 'Sorteia uma porcentagem de chance de macaco pro alvo.',
async execute(ctx) {
...
text:`Pesquisando a ficha de macaco @${sender_ou_n.split("@")[0]}, aguarde...`,
