const { imgsafada } = require('../../config-bot/logos/links_img.json');
module.exports = {
name: 'safada',
category: 'brincadeiras',
description: 'Sorteia uma porcentagem de chance de safada pro alvo.',
async execute(ctx) {
...
text:`Pesquisando a ficha de safada @${sender_ou_n.split("@")[0]}, aguarde...`,
