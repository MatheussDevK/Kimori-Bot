const { imglouco } = require('../../config-bot/logos/links_img.json');
module.exports = {
name: 'louco',
category: 'brincadeiras',
description: 'Sorteia uma porcentagem de chance de louco pro alvo.',
async execute(ctx) {
...
text:`Pesquisando a ficha de louco @${sender_ou_n.split("@")[0]}, aguarde...`,
...
await kiimorizinha.sendMessage(from, {
image: {url: imglouco},
caption: `O quanto *@${sender_ou_n.split("@")[0]}* pode ser um louco?\n• A porcentagem de chance é *${random}%*`,
contextInfo: {...ChannelContextNewsLetter, mentionedJid: [sender_ou_n]}
}, {quoted: selo})
}, 7000)
}
