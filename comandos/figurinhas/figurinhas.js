...
name: 'figurinhas',
category: 'figurinhas',
description: 'Envia N figurinhas aleatórias do Pack 1 (API Kimori).',
async execute(ctx) {
...
if (qtd > 10) qtd = 10;
await reply(`*Enviando ${qtd} figurinha(s) Pack 1*`);
for (let i = 0; i < qtd; i++) {
const response = await axios.get(`${API_KIMORI_URL}/api/figurinhas?apikey=${APIKEY_KIMORI}`, {
