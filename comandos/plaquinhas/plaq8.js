...
name: 'plaq8',
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 8).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq8?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error('[ Erro ] na plaq8:', error);
