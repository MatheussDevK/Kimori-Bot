...
name: 'plaq5',
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 5).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq5?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error('[ Erro ] na plaq5:', error);
