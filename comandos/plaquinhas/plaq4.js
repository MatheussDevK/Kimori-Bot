...
name: 'plaq4',
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 4).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq4?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error('[ Erro ] na plaq4:', error);
