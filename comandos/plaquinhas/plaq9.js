...
name: 'plaq9',
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 9).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq9?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error('[ Erro ] na plaq9:', error);
