...
name: 'plaq7',
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 7).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq7?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error('[ Erro ] na plaq7:', error);
