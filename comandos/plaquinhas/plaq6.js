...
name: 'plaq6',
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 6).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq6?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error('[ Erro ] na plaq6:', error);
