...
name: 'plaq2',
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 2).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq2?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error('[ Erro ] na plaq2:', error);
