...
aliases: ['plaq'],
category: 'plaquinhas',
description: 'Gera uma plaquinha personalizada (modelo 1).',
async execute(ctx) {
...
await reagir(from, "🔞");
try {
const buffer = await getBuffer(`${API_KIMORI_URL}/api/plaq1?query=${encodeURIComponent(q)}&apikey=${APIKEY_KIMORI}`);
...
console.error(' [ Erro ] na plaq1:', error);
